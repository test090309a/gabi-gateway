...
def get_telegram_bot():
    """Get Telegram bot instance - verwendet den Singleton aus integrations."""
    from gateway.integrations.telegram_bot import get_telegram_bot as _get_bot
    return _get_bot()  # Direkt den Singleton zurückgeben
